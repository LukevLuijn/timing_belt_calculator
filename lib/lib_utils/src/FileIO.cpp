...
namespace Utils
{
    /* static */ bool FileIO::readFile(Path path, Buffer buffer, bool fromRoot, int16_t index)
    {
        ...
        {
            std::cerr << "file system error reading [" << filePath << "] " << e.what() << std::endl;
            return false;
        }
        return true;
    }
    /* static */ bool FileIO::createFile(Path path, Name name, bool fromRoot)
    {
        ...
        try
        {
            if (exists(filePath))
            {
                std::cerr << "file already exist! [" << filePath << "]" << std::endl;
                return false;
            }
            else
            {
        ...
        {
            std::cerr << "file system error [" << filePath << "] " << e.what() << std::endl;
            return false;
        }
        return true;
    }
    ...
    /* static */ bool FileIO::readDirectory(Path path, Buffer buffer, bool fromRoot)
    {
        ...
        {
            std::cerr << "file system error reading [" << dirPath << "] " << e.what() << std::endl;
            return false;
        }
        return true;
    }
    /* static */ bool FileIO::createDirectory(Path path, Name name, bool fromRoot)
    {
        ...
        {
            std::cerr << "file system error [" << dirPath << "] " << e.what() << std::endl;
            return false;
        }
        return true;
    }
    /* static */ bool FileIO::removeDirectory(Path path, bool fromRoot)
    {
        ...
        try
        {
            if (!exists(dirPath))
            {
                std::cerr << "directory does not exists! [" << dirPath << "]" << std::endl;
                return false;
            }
            else
            {
    ...
    /* static */ bool FileIO::elementExist(Path path, bool fromRoot)
    {
        ...
        {
            std::cerr << "file system error [" << elementPath << "] " << e.what() << std::endl;
            return false;
        }
    }
